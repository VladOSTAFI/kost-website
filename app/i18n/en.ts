  ...
  cases: [
    {
      ...
      levers: [
        { title: "Expanded campaign structure", text: "Segmented campaigns by direction (health, beauty, pharmacy, sauna), language (en/ru) and audience — enabling precise budget and bid control at the level of each segment." },
        { title: "Feeds with substituted IDs", text: "Created and configured new feeds with substituted IDs to launch separate campaigns with a higher ROAS strategy (up to 600%), driving better traffic quality and lower conversion cost." },
        { title: "Testing additional signals", text: "Systematic testing of audience signals in Performance Max campaigns accelerated algorithm learning and increased placement relevance." },
        { title: "Working with search themes", text: "Analysis and cleanup of search terms, plus DSA campaigns with a 1 product = 1 ad group structure — raising CTR and cutting off non-target traffic." },
      ],
      stack: "Google Ads · Performance Max · Google Shopping · Cosmetics & pharmacy · US market",
    },
    {
      ...
      levers: [
        { title: "Expanded site structure & landing pages", text: "New category and landing pages built around target clusters — capturing a wider pool of search queries and entering the index for new segments." },
        { title: "Expanded semantic clusters", text: "Deep semantic clustering covering brand, category and product-attribute queries — growing from ~0 to 928 ranked keywords." },
        { title: "On-page optimization", text: "Optimized meta tags, headings, internal linking and content structure on existing and new pages — improving relevance and behavioral signals." },
        { title: "Technical SEO audit", text: "Full technical audit: indexation, load speed, URL structure, duplicate pages and metadata correctness — issues resolved before the core work began." },
        { title: "Off-page optimization (link building)", text: "Grew the backlink profile: +23 new backlinks (+88%) across 24 unique domains — strengthening domain authority and accelerating visibility growth." },
      ],
      stack: "SEO · On-page & Off-page · Premium menswear",
    },
    {
      kind: "SEO · B2B",
      ...
      levers: [
        { title: "Technical SEO audit", text: "Technical audit at the start: indexation, speed, URL structure, duplicates and metadata correctness — issues fixed before core work began." },
        { title: "Expanded site structure & landing pages", text: "New category and landing pages for B2B queries — crushed stone, sand, fractions and regions — capturing a wider pool of commercial queries." },
        { title: "Expanded semantic clusters", text: "Clustering for B2B intent: wholesale supply, material specs and regional queries — growing from ~0 to 589 ranked keywords." },
        { title: "On-page optimization", text: "Optimized meta tags, headings, internal linking and content structure — improving relevance for commercial and informational queries." },
        { title: "Off-page optimization (link building)", text: "Built a backlink profile from zero: 191 backlinks across 36 donor domains — strengthening authority and ensuring steady visibility growth." },
      ],
      stack: "SEO · On-page & Off-page · B2B · Crushed stone & sand",
    },
  ],
